...
function Catalog()       { return <div>Catalog</div> }
...
function Dashboard()     { return <div>Admin Dashboard</div> }
function AdminProducts() { return <div>Admin Products</div> }
function AdminOrders()   { return <div>Admin Orders</div> }
